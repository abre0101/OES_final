...
// Validate user role - only department heads can access this page
    ...
    <div class="admin-main-content">
        ...
        <div class="admin-content">
            ...
            <div style="margin-bottom: 2rem;">
                <h1 style="font-size: 2rem; margin: 0 0 0.35rem 0; color: var(--primary-color); font-weight: 700;">Department Head Dashboard</h1>
