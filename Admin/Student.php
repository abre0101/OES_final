...
<body class="admin-layout">
            ...
            <div class="students-grid">
                ...
                if($result && $result->num_rows > 0) {
                    while($row = $result->fetch_array()) {
                        ...
                        $Year = $row['semester'] ?? 'N/A'; // Using semester as year
                ...
                <div class="student-card">
                    ...
                    <div class="student-actions">
                        <a href="EditStudent.php?student_id=<?php echo $Id; ?>" class="action-btn edit">
                            <span>✏️</span> Edit
                        </a>
    ...
    <script>
        ...
        // Auto-suggest username based on student name
        const studentNameInput = document.getElementById('txtName');
        const usernameInput = document.getElementById('txtUserName');
        let manuallyEdited = false;
        
        if (studentNameInput && usernameInput) {
