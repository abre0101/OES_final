...
-- Exam 1: Fundamentals of Nursing - Midterm (Approved)
...
-- Exam 2: Anatomy and Physiology - Midterm (Approved)
...
-- Exam 3: Introduction to Midwifery - Midterm (Approved with revision)
...
-- Exam 4: Introduction to Public Health - Midterm (Approved)
...
-- Exam 5: Fundamentals of Anesthesia - Midterm (Approved)
...
(5, 'approved', 3, 'department_head', 'Excellent technical content. Safety protocols are well emphasized. Approved without changes.', 'pending', 'approved', '2026-02-05 14:00:00'),

-- Exam 6: Clinical Chemistry - Midterm (Rejected then resubmitted)
